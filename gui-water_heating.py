...
def main():
    ...
    title_look = figure.create_text(220, 40, text=title, justify=tk.CENTER, font=FONT_ENTRY)
    ready_look = figure.create_text(200, 110, text=ready_text, font=FONT_COMMANDS)
    graph_look = figure.create_text(230, 170, text=graph_text, justify=tk.CENTER, font=FONT_COMMANDS)
    ...
    ready['command'] = lambda : show_result(figure, title_look, ready_look, graph_look,
